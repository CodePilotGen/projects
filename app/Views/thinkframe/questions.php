    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link" href="<?= base_url() ?>/thinkframe/questions">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?= base_url() ?>/thinkframe/options">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?= base_url() ?>/thinkframe/hyps">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Hypothesis</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
                    ...
                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                <div class="menu-item here show menu-lg-down-accordion">
                                    <span class="menu-link py-3">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link active py-3" href="apps/user-management/users/list.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Users List</span>
...
<div class="post d-flex flex-column-fluid" id="kt_post">
    <!--begin::Container-->
    <div id="kt_content_container" class="container" style="width: 50%;">
        <!--begin::Card-->
        <div class="card">
            <!--begin::Card header-->
            <div class="card-header border-0 pt-6">
                <button type="button" id="add_new_question" class="btn btn-lg btn-primary" data-kt-stepper-action="next">
                    <i class="fas fa-question"></i>&nbsp;ADD NEW QUESTION 
                </button>

                <button type="button" id="save_question" class="btn btn-lg btn-primary" data-kt-stepper-action="next">
                    <i class="fas fa-database"></i>&nbsp;SAVE QUESTION 
                </button>
            </div>
            <!--end::Card header-->
            <!--begin::Card body-->
    ...
    <!--begin::Container-->
    <div id="kt_content_container1" class="container" style="width:50%;">
        <!--begin::Card-->
        <div class="card">
            <!--begin::Card header-->
            <div class="card-header border-0 pt-6">
                <button type="button" id="add_new_hyp" class="btn btn-lg btn-primary" style="height: 50px; display: block;">ADD NEW HYPOTHESIS</button>
                <div class="hyps-list">
                </div>
            </div>
            <!--end::Card header-->
...
<script>
    ...
    var new_question = '<div class="question-block" id="question_block_{{question_id}}" question_id="{{question_id}}">' +
                            '<div class="question-box">' +
                                '<input type="text" placeholder="Please enter question." class="form-control form-control-solid question-content" />' +
    ...
    var new_option =    '<div class="option-box" id="option_box_{{question_id}}_{{option_id}}" option_id="{{option_id}}">' +
                            '<input type="text" placeholder="Please enter option." class="form-control form-control-solid option-content" />' +
    ...
    var new_hyp =  '<div class="hypo-box" id="hypo_box_{{question_id}}_{{option_id}}_{{hyp_id}}" hyp_id="{{hyp_id}}">' +
                        '<select class="form-select form-select-sm hypo-list" aria-label=".form-select-sm example">' +
                          '<option selected>Select hypothesis</option>' +
                          '<option value="1">One</option>' +
                          '<option value="2">Two</option>' +
                          '<option value="3">Three</option>' +
                        '</select>' +
                        '&nbsp;#<input type="text" placeholder="point" class="form-control form-control-solid option-point">' +
                    '</div>';
    ...
    $(document).on('click','.add-option', function(e){
        new_option_id++; // increase option id one bye one
    ...
    function JsonFromHtml(){
        $('.question-block').each(function(i,box){
            $question_block = $(this);
            
            $question_id = $question_block.attr('question_id');
            $question_content = $question_block.find('.question-box > input').val();

            $question_block.find('.option-box').each(function(k,o_box){
                console.log($(o_box).attr('option_id'))  // option_id
                console.log($(o_box).find('.option-content').val());

                $(o_box).find('.hypo-box').each(function(m, h_box){
                    console.log($(h_box).find('select').val());
                    console.log($(h_box).find('.option-point').val());
                });
            }); 
