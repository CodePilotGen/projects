        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?= base_url() ?>/thinkframe/combos">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                <div class="menu-item me-lg-1">
                    <button type="button" id="add_new_hyp" class="btn btn-lg btn-primary">
                        <i class="fas fa-question"></i>&nbsp;ADD NEW HYPOTHESIS 
                    </button> 
                </div>
            </div>
            <!--end::Menu-->
...
<script>
    ...
    $.post('/getdatainjson/getMaxIds', function(result){
        ...
        $.post('/getdatainjson/allhyps', function(result){
                    ...
                    for(var n in options){
                        $('#hyp_block_' + i).append(
                            option_in_hyp.compose({
                                ...
                                'option_hyp_point' : options[n].option_hyp_point
                            })
                        );
                    }
                }
    ...
    $(document).on('click', '.remove-hyp', function(e){
        ...
        $.post('/getdatainjson/delete_hyp',{
                ...
                if(status == 'success'){
                    ...
                    setTimeout(function() {
                      alert('Hypothesis successfully deleted.');
                    }, 1000);
                }
            });
    });
                ...
                if(status == 'success'){
                   //
                    setTimeout(function() {
                      ...
                      $(e.target).next().removeClass('option-content-alert');
                    }, 1000);
                }
        });
    });
