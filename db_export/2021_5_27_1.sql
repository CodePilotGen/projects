...
(14,1,'leo','eagle','2','127.0.0.1','2021-05-26 17:31:42',1),
(15,1,'leo','eagle','2','127.0.0.1','2021-05-26 18:46:44',1);
...
CREATE TABLE `combo_hypo` (
  `combo_hypo_id` int(11) NOT NULL AUTO_INCREMENT,
  `combo_id` int(11) NOT NULL,
  `hypo_id` int(11) NOT NULL,
  PRIMARY KEY (`combo_hypo_id`),
  KEY `combo_id` (`combo_id`),
  KEY `hypo_id` (`hypo_id`),
  CONSTRAINT `combo_hypo_ibfk_1` FOREIGN KEY (`combo_id`) REFERENCES `combo` (`combo_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `combo_hypo_ibfk_2` FOREIGN KEY (`hypo_id`) REFERENCES `hypo` (`hypo_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
/*Table structure for table `hypo` */

DROP TABLE IF EXISTS `hypo`;

CREATE TABLE `hypo` (
  `hypo_id` int(11) NOT NULL AUTO_INCREMENT,
  `hypo_content` text NOT NULL,
  PRIMARY KEY (`hypo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `hypo` */
...
CREATE TABLE `input` (
  ...
  CONSTRAINT `input_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `input_ibfk_2` FOREIGN KEY (`option_id`) REFERENCES `option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `option` (
  `option_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'option id',
  `option_content` text NOT NULL,
  `question_id` int(11) NOT NULL,
  `hypo_id` int(11) DEFAULT NULL,
...
CREATE TABLE `option_hypo` (
  ...
  KEY `option_id` (`option_id`),
  KEY `hypo_id` (`hypo_id`),
  CONSTRAINT `option_hypo_ibfk_1` FOREIGN KEY (`option_id`) REFERENCES `option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `option_hypo_ibfk_2` FOREIGN KEY (`hypo_id`) REFERENCES `hypo` (`hypo_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `question` (
  `question_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'question id',
  `question_content` text NOT NULL COMMENT 'question content',
